...
const createInvoices = (request, response, invoice) => {
    ...
    "charges_sum, total_without_vat, total_vat_amount, total_with_vat, paid_amount, amount_due_for_payment, payment_method, warranty, vat_exemption_reason, operator_name, operator_tax_number, zoi, eor, invoice_special_notes, reverted, created_date, device_id, premise_id, item_id," +
    ...
    + invoice.lines_sum + ", " + invoice.discount_sum + ", " + invoice.charges_sum + ", " + invoice.total_without_vat + ", " + invoice.total_vat_amount + ", " + invoice.total_with_vat + ", " + invoice.paid_amount + ", " + invoice.amount_due_for_payment + ",'" + invoice.payment_method + "', " + invoice.warranty + ", '" + invoice.vat_exemption_reason + "', '" + invoice.operator_name + "', '" + invoice.operator_tax_number + "'," + 
     ...
     "NOW()," + invoice.device_id + ", " + invoice.premise_id + ", " + invoice.item_id + ", " + invoice.business_customer_id + ", '" + invoice.invoice_status + "')"
