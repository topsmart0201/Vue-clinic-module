...
const getClinicStatistics = async (request, response, prm_client_id, scope) => {
    ...
    if (scope == 'All') {
        ...
        var weeklyStatement = ["SELECT date_trunc('week',date)::date as date, SUM(cash_amount) AS cachRevenue, SUM(credit_card_amount) AS cardRevenue, SUM(cash_amount) + SUM(credit_card_amount) AS totalRevenue FROM services where date > current_date - interval '1 week' GROUP BY ( date_trunc('week', date)) ORDER BY ( date_trunc('week', date)) ASC "].join('\n')
        var monthlyStatement = ["SELECT date_trunc('month',date)::date as date, SUM(cash_amount) AS cachRevenue, SUM(credit_card_amount) AS cardRevenue, SUM(cash_amount) + SUM(credit_card_amount) AS totalRevenue FROM services where date > current_date - interval '1 month' GROUP BY ( date_trunc('month', date)) ORDER BY ( date_trunc('month', date)) ASC "].join('\n')
        var yearlyStatement = ["SELECT date_trunc('year',date)::date as date, SUM(cash_amount) AS cachRevenue, SUM(credit_card_amount) AS cardRevenue, SUM(cash_amount) + SUM(credit_card_amount) AS totalRevenue FROM services where date > current_date - interval '1 year' GROUP BY ( date_trunc('year', date)) ORDER BY ( date_trunc('year', date)) ASC "].join('\n')
    } else if (scope == 'PrmClient') {
        var todayStatement = ["SELECT date_trunc('day',date)::date as date, SUM(cash_amount) AS cachRevenue, SUM(credit_card_amount) AS cardRevenue, SUM(cash_amount) + SUM(credit_card_amount) AS totalRevenue FROM services LEFT JOIN enquiries ON services.enquiry_id = enquiries.id where date = CURRENT_DATE AND enquiries.prm_client_id = " + prm_client_id + " GROUP BY ( date_trunc('day', date)) ORDER BY ( date_trunc('day', date)) ASC "].join('\n')
        var sixtyWeekStatement = ["SELECT date_trunc('week',date)::date as date, SUM(cash_amount) AS cachRevenue, SUM(credit_card_amount) AS cardRevenue, SUM(cash_amount) + SUM(credit_card_amount) AS totalRevenue FROM services LEFT JOIN enquiries ON services.enquiry_id = enquiries.id where date > current_date - interval '60 weeks' AND enquiries.prm_client_id = " + prm_client_id + " GROUP BY ( date_trunc('week', date)) ORDER BY ( date_trunc('week', date)) ASC "].join('\n')
        var weeklyStatement = ["SELECT date_trunc('week',date)::date as date, SUM(cash_amount) AS cachRevenue, SUM(credit_card_amount) AS cardRevenue, SUM(cash_amount) + SUM(credit_card_amount) AS totalRevenue FROM services LEFT JOIN enquiries ON services.enquiry_id = enquiries.id where date > current_date - interval '1 week' AND enquiries.prm_client_id = " + prm_client_id + " GROUP BY ( date_trunc('week', date)) ORDER BY ( date_trunc('week', date)) ASC "].join('\n')
        var monthlyStatement = ["SELECT date_trunc('month',date)::date as date, SUM(cash_amount) AS cachRevenue, SUM(credit_card_amount) AS cardRevenue, SUM(cash_amount) + SUM(credit_card_amount) AS totalRevenue FROM services LEFT JOIN enquiries ON services.enquiry_id = enquiries.id where date > current_date - interval '1 month' AND enquiries.prm_client_id = " + prm_client_id + " GROUP BY ( date_trunc('month', date)) ORDER BY ( date_trunc('month', date)) ASC "].join('\n')
        var yearlyStatement = ["SELECT date_trunc('year',date)::date as date, SUM(cash_amount) AS cachRevenue, SUM(credit_card_amount) AS cardRevenue, SUM(cash_amount) + SUM(credit_card_amount) AS totalRevenue FROM services LEFT JOIN enquiries ON services.enquiry_id = enquiries.id where date > current_date - interval '1 year' AND enquiries.prm_client_id = " + prm_client_id + " GROUP BY ( date_trunc('year', date)) ORDER BY ( date_trunc('year', date)) ASC "].join('\n')
    }
