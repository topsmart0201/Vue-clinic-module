...
export default {
  ...
  data () {
    return {
      ...
      perPage: 10,
      columns: [
        { label: 'Completed', key: 'completed', class: 'text-left' },
        { label: 'Description', key: 'description', class: 'text-left' },
        { label: 'Patient name', key: 'patientname', class: 'text-left' },
        { label: 'Patient last name', key: 'patientlastname', class: 'text-left' },
